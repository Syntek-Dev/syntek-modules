...
export type CurrentUserQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, email: string, createdAt: string, roles: Array<{ __typename?: 'Role', id: string, name: string, permissions: Array<{ __typename?: 'Permission', name: string, scope: string }> }> } | null };

export type CurrentTenantQueryVariables = Exact<{ [key: string]: never; }>;


export type CurrentTenantQuery = { __typename?: 'Query', currentTenant?: { __typename?: 'Tenant', id: string, slug: string, name: string } | null };
...
export const useCurrentTenantQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<CurrentTenantQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<CurrentTenantQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<CurrentTenantQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['CurrentTenant'] : ['CurrentTenant', variables],
    queryFn: fetcher<CurrentTenantQuery, CurrentTenantQueryVariables>(CurrentTenantDocument, variables),
    ...options
  }
    )};
