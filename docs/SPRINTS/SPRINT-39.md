...
**Sprint Goal**: Implement the multi-step onboarding wizard with resumable state, and the donation form UI with Gift Aid capture and campaign progress display.

**Total Points**: 10 / 11
**MoSCoW Balance**: Should 80% / Could 20%
**Status**: Planned
...
- US068 Gift Aid checkbox must display the full HMRC-required declaration text — this is a legal requirement.
