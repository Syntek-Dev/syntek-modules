...
**Sprint Goal**: Implement the events and ticketing module with capacity management, QR code check-in, ticket transfer, and waitlist support.
...
- Event notifications (reminders, confirmations, cancellations) must dispatch via US019 (notifications).
