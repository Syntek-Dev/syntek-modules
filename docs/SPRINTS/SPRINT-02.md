...
**Total Points**: 15 / 11 ⚠️ OVER CAPACITY **MoSCoW Balance**: Must 100% **Status**: Planned
...
- ⚠️ This sprint is 15 points, but all three stories are fully independent and target different team
  members working in parallel — US003 (design tokens), US005 (CI/CD pipeline), and US074 (Rust
  manifest crate). Each is a focused 5-point effort with no shared files.
