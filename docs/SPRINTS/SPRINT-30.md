# Sprint 30 — Membership & Integrations Framework

**Sprint Goal**: Implement the membership tiers and renewals module with member directory, and the
integrations framework providing OAuth bridges for EspoCRM, CalDav, and third-party services.
