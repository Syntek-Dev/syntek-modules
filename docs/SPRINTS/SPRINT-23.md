...
**Sprint Goal**: Implement the donations module with one-off and recurring donation processing, UK Gift Aid declaration management, campaign tracking, and donor receipts.
...
- Gift Aid declarations must be stored with a full audit trail (US013) — HMRC compliance requirement.
