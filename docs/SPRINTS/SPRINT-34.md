...
**Sprint Goal**: Implement the application layout shell package (sidebar, top nav, breadcrumbs, command palette) and the GDPR/cookie consent UI package.
...
- US049 consent choices must be persisted and synced to the backend US029 (GDPR) module — not just stored in localStorage.
