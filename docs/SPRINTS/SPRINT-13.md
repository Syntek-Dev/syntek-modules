...
**Sprint Goal**: Implement the multi-channel notification system (in-app, push, SMS, email) with per-user preferences, and the geolocation module with UK postcode lookup and `nearby()` spatial queries.
