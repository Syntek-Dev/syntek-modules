...
**Sprint Goal**: Implement the Celery-based background task queue with priority lanes and dead-letter queue, and the per-tenant typed key-value settings store.
