...
**Sprint Goal**: Implement the HTTP security middleware layer (rate limiting, CORS, CSP, HSTS, IP
blocking) and the structured JSON logging module with Sentry/Glitchtip integration.
