...
**Sprint Goal**: Implement the reporting module with PDF, Excel, and CSV export support, scheduled report delivery, and role-based report access control.
...
- Report generation must be async via Celery (US015) — large reports must not block the request cycle.
