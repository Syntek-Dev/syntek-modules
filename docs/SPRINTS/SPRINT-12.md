...
**Sprint Goal**: Implement per-tenant feature flag management with percentage rollout, and the
groups/teams module with nested group hierarchy and org structure support.
